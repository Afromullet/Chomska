...
def Forward(context):
    ...
    if context["continue_drawing"]:
        ...
        pygame.draw.line(context["drawing_window"],lineColor,context["current_position"],next_vec,width=lineWidth)
...
def Positive_Turn(context):
    if context["continue_drawing"]:
        ...
        if context["rule_parameters"]:
            variables = Util.get_parameters(context["rule_parameters"])
            context["old_angle"] = context["angle"]
            context['angle'] = variables['angle']
