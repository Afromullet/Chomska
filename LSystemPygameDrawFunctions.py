...
'''
Basic Pygame drawing functions for tokens without parameters. Todo this can be removed once the parameter stuff is implemeted
...
def Forward(context):
    ...
    if context["continue_drawing"]:
        ...
        pygame.draw.line(context["drawing_window"],(0, 0, 255),context["current_position"],next_vec)
